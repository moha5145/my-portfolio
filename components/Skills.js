  ...
  return (
    <section id="skills" className=" bg-skills h-[100%] md:h-screen w-full text-center p-2 md:py-20 text-slate-400  ">
      <div className="container mx-auto flex flex-col md:gap-28 gap-5  ">
        ...
        <div className=" grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-16 ml-10 md:pt-18  items-center mt-auto animate-bounce">
          <div className="flex flex-col justify-center items-center">
            <div className=" h-20 w-16 relative animate-bounce">
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="h-20 w-16  relative animate-spin">
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="h-20 w-16  relative animate-pulse">
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="h-20 w-16  relative animate-ping">
